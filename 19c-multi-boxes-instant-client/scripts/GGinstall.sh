...
yum -y -q install oracle-instantclient19.8-basic.x86_64 19.8.0.0.0-1
yum -y -q install oracle-instantclient19.8-devel.x86_64 19.8.0.0.0-1
yum -y -q install oracle-instantclient19.8-sqlplus.x86_64 19.8.0.0.0-1
yum -y -q install oracle-instantclient19.8-tools.x86_64 19.8.0.0.0-1
